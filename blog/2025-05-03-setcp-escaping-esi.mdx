...
Key information like names, dates, and organizations are left out to protect the innocent, **and me**, from lawsuits, and superfluous trips to HR...which in all actuality would likely warrant a future blog post.

Though the savvy sleuth may indubitably deduce some details, I maintain the hypothetical nature of the case studies outlined herein, heretofore, and/or hereunto.
